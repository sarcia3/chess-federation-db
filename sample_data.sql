...
-- ----------------------------------------------------------------------------
-- Historical ratings (for the rating history graph).
-- Quarterly points through 2024 that chain into the 2025-01-01 baseline above
-- (the current row, date_to IS NULL). Each closed period has date_to > date_from
-- so the CHECK (date_from < date_to) holds, and the values zig-zag up toward the
-- baseline so each player's line has a visible shape.
-- ----------------------------------------------------------------------------

-- Classical (chess_type 1) — all eight players.
INSERT INTO rating_history (player_id, value, chess_type_id, date_from, date_to) VALUES
    (1, 2809, 1, '2024-01-01', '2024-04-01'), (1, 2829, 1, '2024-04-01', '2024-07-01'), (1, 2814, 1, '2024-07-01', '2024-10-01'), (1, 2834, 1, '2024-10-01', '2025-01-01'),
    (2, 2772, 1, '2024-01-01', '2024-04-01'), (2, 2792, 1, '2024-04-01', '2024-07-01'), (2, 2777, 1, '2024-07-01', '2024-10-01'), (2, 2797, 1, '2024-10-01', '2025-01-01'),
    (3, 2775, 1, '2024-01-01', '2024-04-01'), (3, 2795, 1, '2024-04-01', '2024-07-01'), (3, 2780, 1, '2024-07-01', '2024-10-01'), (3, 2800, 1, '2024-10-01', '2025-01-01'),
    (4, 2753, 1, '2024-01-01', '2024-04-01'), (4, 2773, 1, '2024-04-01', '2024-07-01'), (4, 2758, 1, '2024-07-01', '2024-10-01'), (4, 2778, 1, '2024-10-01', '2025-01-01'),
    (5, 2698, 1, '2024-01-01', '2024-04-01'), (5, 2718, 1, '2024-04-01', '2024-07-01'), (5, 2703, 1, '2024-07-01', '2024-10-01'), (5, 2723, 1, '2024-10-01', '2025-01-01'),
    (6, 2701, 1, '2024-01-01', '2024-04-01'), (6, 2721, 1, '2024-04-01', '2024-07-01'), (6, 2706, 1, '2024-07-01', '2024-10-01'), (6, 2726, 1, '2024-10-01', '2025-01-01'),
    (7, 2725, 1, '2024-01-01', '2024-04-01'), (7, 2745, 1, '2024-04-01', '2024-07-01'), (7, 2730, 1, '2024-07-01', '2024-10-01'), (7, 2750, 1, '2024-10-01', '2025-01-01'),
    (8, 2728, 1, '2024-01-01', '2024-04-01'), (8, 2748, 1, '2024-04-01', '2024-07-01'), (8, 2733, 1, '2024-07-01', '2024-10-01'), (8, 2753, 1, '2024-10-01', '2025-01-01');

-- Rapid (chess_type 2) — the four rapid players.
INSERT INTO rating_history (player_id, value, chess_type_id, date_from, date_to) VALUES
    (1, 2800, 2, '2024-01-01', '2024-04-01'), (1, 2820, 2, '2024-04-01', '2024-07-01'), (1, 2805, 2, '2024-07-01', '2024-10-01'), (1, 2825, 2, '2024-10-01', '2025-01-01'),
    (2, 2849, 2, '2024-01-01', '2024-04-01'), (2, 2869, 2, '2024-04-01', '2024-07-01'), (2, 2854, 2, '2024-07-01', '2024-10-01'), (2, 2874, 2, '2024-10-01', '2025-01-01'),
    (3, 2743, 2, '2024-01-01', '2024-04-01'), (3, 2763, 2, '2024-04-01', '2024-07-01'), (3, 2748, 2, '2024-07-01', '2024-10-01'), (3, 2768, 2, '2024-10-01', '2025-01-01'),
    (5, 2750, 2, '2024-01-01', '2024-04-01'), (5, 2770, 2, '2024-04-01', '2024-07-01'), (5, 2755, 2, '2024-07-01', '2024-10-01'), (5, 2775, 2, '2024-10-01', '2025-01-01');
